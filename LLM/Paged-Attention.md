...
![Pasted image 20260821110423](../Images/Pasted%20image%2020260821110423.png)

每个线程定义自己的 `q_ptr`，指向全局内存中分配给它的 query token 数据。例如，若 `VEC_SIZE` 为 4 且
`HEAD_SIZE` 为 128，则 `q_ptr` 指向包含共 128 个元素的数据，这些元素被划分为 128 / 4 = 32 个向量。![Pasted image 20260821110648](../Images/Pasted%20image%2020260821110648.png)
```cpp
...
![Pasted image 20260821110726](../Images/Pasted%20image%2020260821110726.png)
...
![Pasted image 20260821110748](../Images/Pasted%20image%2020260821110748.png)
...
![Pasted image 20260821111846](../Images/Pasted%20image%2020260821111846.png)
![Pasted image 20260821111855](../Images/Pasted%20image%2020260821111855.png)
![Pasted image 20260821111912](../Images/Pasted%20image%2020260821111912.png)
