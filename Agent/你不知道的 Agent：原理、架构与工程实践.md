...
![Agent Loop 控制流](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM4L7KwRfylJDaTRyxtSiapvibgpXBFicfSYegvVJKpibEFLKb1GKtQfic2UZUvVJdFbDzO6HKeokOCweSBYqqdJY3G1OwSzlz1C8k63bQ4cvjWaLKA/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=1)
...
![Workflow 与 Agent 对比](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM52ibibwuWgdicMNrKZaRqr4xX6Rfuns1lsSp3vzEOCyLhd9Elic68AgFQ602XlhQ7TscQSQDEOgYV78OoQZA2UOkMEksDxvVEC7KmVicecIRKBU1Q/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=2)
...
![五种常见控制模式](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM6icM2k9mBwLNWicjKpPD8TOt9Owj6FWOicEbMLsBMubdxbjaVxMaWLtL371pQbKQkkUlmO98wrG4hCQdCB5uQdxRBeR5oT71gk524dN6hUFEsLQ/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=3)
...
![Codex 可观测性栈](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM74j3oxUZg3cvnLXcdvI3vmyYfbPzMCGiaYFRRB0QibTtia2Mo3iaxbInAyibag6WbrKkcBG7IYVt4lwSF28ow4fUULZBicaqnQicvo1uFZfmtYY81kA/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=4)
...
![Harness 关键结论](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM43lOLib3YMzKiaBrMN9GJnIB2Q8AicAenvUDpwS60bynC9XqXIia2Hz64Q7JBw0euzibgtlIziaWEXAbicYAnIKV8eBmdsO7GXw4ctrkHuboHGey8Cg/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=5)
...
![上下文分层结构](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM7hcjJTb3mianKKib16HBJcYz0FqtL35RYWaKc9w1fPkOiao5biakR2YexuEDdnR8XVibzEBZchhrDva2lBCnWmuU5sdhGiazu5P8FaAibicERKFIu79A/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=6)
...
![Skills 按需加载](https://mmbiz.qpic.cn/sz_mmbiz_png/yE1BYA2cY11RpwSEib7bn80Gs3JR9hDgCUuAm9Xjkd2WKw25icmHXpgj8V3c8dpicKibvDicI7gSQLjHmAJv6ytRj2DfvStHbbBjUQnd0keodvKU/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=7)
...
![ACI 工具设计对比：差工具设计会让 Agent 反复绕圈，好工具设计能让 Agent 更快选对并修正错误](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM6ibXlVa7ShibK5ibhTkcZ9f8fhzzOHeLeISrdoWrHsDyafhVL3IiaaqVRVyM8Re74nJiawSUCKmGvziacJdPib9uYic9kxeXsUSnr6AXH1au2iaVWd7GQ/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=8)
...
![四种记忆类型与存储位置：上下文窗口位于运行时 messages[]，Skills、JSONL 会话历史和 MEMORY.md 位于磁盘，生命周期和注入方式各不相同](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM6RUVDUAvBfm5tJqVTlE7pA7uxx3WlHbic0PI3gehku7ictQib67QYMjFqFTzzGazfXczRWauatogib0nZJxichVrekmoS4kzAZg0OTS7icRdEmOD4A/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=9)
...
![记忆整合与回退流程：消息流在 token 使用率超过阈值后触发整合，成功时摘要写入 MEMORY.md 并移动整合指针，失败时原始消息写入 archive/ 保留完整历史](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM5yMic4s5uB3QYzG6jsXIRqRCuY5oemKBY2VjyRIUW5mVzpF1ectib2MBIZhrYibNPt8dfzKR5ZCf8PfEKzpdic8Ewc38kGbDoxCicTK1vuenrgNzw/640?wx_fmt=svg&from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=10)
...
![Initializer + Coding Agent 跨 session 协作流程：Initializer 只运行一次并生成 feature-list.json、init.sh、初始 commit 和 claude-progress.txt，后续 Coding Agent 在多个 session 中通过文件系统恢复状态、实现单个功能、测试、更新 passes 并提交代码](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
...
![多 Agent 拓扑](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
...
![多 Agent 协作协议](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
...
![Single-turn vs Agent 评测对比：Single-turn 是 Prompt 进 LLM 出 Response 直接打分，Agent 则需要 Tools、Environment、Task 协同，Agent 多步调用工具并更新环境状态，最后验证环境实际结果而非只看输出文字](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
...
![Agent 评测的组成部分：task、trial、grader、transcript、outcome、evaluation harness、agent harness 和 evaluation suite](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
...
|   |   |
|---|---|
|![调查：团队实际使用的评测方式，Offline evaluation on test sets 54.5%，Online evaluation on production data 44.8%，Not evaluating yet 22.8%](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)|![调查：常用评测指标，Internal human review/labelling 59.8%，LLM-as-judge 53.3%，Traditional ML/DS metrics 16.9%](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)|
...
![Success rate vs infra error rate：横轴是评测容器的资源余量从 1x 到 Uncapped，蓝色是模型得分，红色是基础设施错误率，资源越受限红色越高蓝色越低](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
...
![两层可观测性](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
...
![OpenClaw 整体架构](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
...
![系统提示分层叠加](data:image/svg+xml,%3C%3Fxml%20version='1.0'%20encoding='UTF-8'%3F%3E%3Csvg%20width='1px'%20height='1px'%20viewBox='0%200%201%201'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate\(-249.000000,%20-126.000000\)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)
